...
function cinematic() {
	for(var i = 1; i <=3 ; i++) {
	document.getElementById('jogo').innerHTML += "<img id='gradefechada"+i+"' src='imagens/gradefechada.png'>";
	document.getElementById('gradefechada' + i).style.height = "8%";
	document.getElementById('gradefechada' + i).style.position = "absolute";
	document.getElementById('gradefechada' + i).style.bottom = Math.floor(Math.random()*window.innerHeight)+"px";
	document.getElementById('gradefechada' + i).style.left = Math.floor(Math.random()*window.innerWidth)+"px";
	...
	document.getElementById('gradeaberta'+i).style.bottom = document.getElementById('gradefechada'+i).style.bottom;
	document.getElementById('gradeaberta'+i).style.left = document.getElementById('gradefechada'+i).style.left;
	document.getElementById('gradeaberta'+i).style.display = "none";
	}
	
	document.getElementById('jogo').innerHTML += "<img id='staine' src='imagens/stan_direita.png'>";
	document.getElementById('staine').style.height = "30%";
	document.getElementById('staine').style.position = "absolute";
	document.getElementById('staine').style.bottom = "0px";
	document.getElementById('staine').style.left = "-"+ (Math.random()*500) + "px";
	document.getElementById('staine').style.zIndex = "1";

	document.getElementById('jogo').innerHTML += "<img id='manivela' src='imagens/manivelacima.png'>";
	document.getElementById('manivela').style.height = "19%";
	document.getElementById('manivela').style.position = "absolute";
	document.getElementById('manivela').style.bottom = "-10px";
	document.getElementById('manivela').style.left = 1000 + "px";
	
	var timerStaine = setInterval(function() {
		for (var i = 1 ; i <= 3 ; i++) {
		document.getElementById('staine').style.left = parseInt(document.getElementById('staine').style.left) + 1 + "px";
		
		if(parseInt(document.getElementById('staine').style.left) >= parseInt(document.getElementById('manivela').style.left)) {
			
			document.getElementById('staine').src = "imagens/stan_costas.png";
			
			var timerStaine2 = setInterval(function() {
			
			document.getElementById('manivela').src = "imagens/manivelabaixo.png";
			
			for(var i = 1 ; i <= 3 ; i++) {
				
				document.getElementById('gradefechada'+i).style.display = "none";
				document.getElementById('gradeaberta'+i).style.display = "block";
				document.getElementById('gradeaberta'+i).style.position = "absolute";
				document.getElementById('gradeaberta'+i).style.top = document.getElementById('gradefechada'+i).style.top;
				document.getElementById('gradeaberta'+i).style.left = document.getElementById('gradefechada'+i).style.left;
				}
			...
			clearInterval(timerStaine);
			var staine_name = "staine";
			var manivela_name = "manivela";
			fadeOutEffect(staine_name);
			fadeOutEffect(manivela_name);
		}
	}
	},(60/1000));
...
function nextLevel() {
	window.location.replace("loadingscreen4.html");
}
